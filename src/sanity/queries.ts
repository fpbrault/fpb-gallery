...
*[_type == "album" && slug.current == $slug][0]{
  ...
  display,
  columns,
  "description": albumContent[language == $locale][0].value,
...
const postSummaryProjection = `{
  ...
  "excerpt": array::join(string::split(pt::text(postContent[language == $locale][0].value), "")[0...255], "") + "..."
}`;
...
*[_type == "post" && (slug.current == $slug || slug_fr.current == $slug)][0]{
  "current": {
    ...
    "title": title[language == $locale][0].value,
    "content": postContent[language == $locale][0].value
  },
