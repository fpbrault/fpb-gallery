...
// Query: *[_type == "album" && slug.current == $slug][0]{  _id,  albumName,  slug,  display,  columns,  "description": albumContent[language == $locale || _key == $locale][0].value,  "category": category->{categoryName, slug},  "images": images[]{  _key,  _type,  alt,  asset,  description,  decorative,  featured,  title,  "placeholders": {"metadata": {"lqip": asset->metadata.lqip}}}}
