...
export default function Post({ post }: { post: PostData }) {
  ...
  const coverImageData = createDataAttribute({
    baseUrl: "/studio",
    id: post.id,
    path: "coverImage",
    type: "post"
  ...
  return (
    <div className="max-w-6xl mx-auto font-sans text-center text-base-content">
      <article key={post.slug}>
        <div className="max-w-4xl mx-auto" data-sanity={coverImageData} data-sanity-edit-target="">
          {image ? (
            <Image
              className="mx-auto rounded shadow-2xl max-h-187.5 object-contain max-w-fit"
